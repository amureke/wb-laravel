...
class EventsController extends BaseController
{
    ...
    {
        $eventwithWS = Event::with('workshops')->get();
        return response()->json($eventwithWS);
    }
    ...
    public function getFutureEventsWithWorkshops()
    {
        ...
        // Get past events ids
        $pastIds = Workshop::where('start', '<', $startDate)->groupBy('event_id')->pluck('event_id');

        // Get all events except events that already started
        $futureData = Event::with('workshops')->whereNotIn('id', $pastIds)->get();
        return response()->json($futureData);
    }
}
